...
export const TradeOfferOptionalDefaultsSchema = TradeOfferSchema.merge(z.object({
  status: TradeOfferStatusSchema.optional(),
  id: z.string().uuid().optional(),
  createdAt: z.coerce.date().optional(),
}))

export type TradeOfferOptionalDefaults = z.infer<typeof TradeOfferOptionalDefaultsSchema>
